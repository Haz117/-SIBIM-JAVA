...
class CategoriasControllerSmokeTest extends ControllerSmokeTestBase {

    @Override
    public void start(Stage stage) throws Exception {
        DatabaseConfig.setDemoMode(true);
        SessionManager.setCurrentUser(adminUser());
        Parent root = new FXMLLoader(getClass().getResource("/fxml/categorias.fxml")).load();
    ...
    void nodosClavePresentes() {
        ...
        assertNotNull(lookup("#lblTotal").query(),    "lblTotal debe existir");
    }
}
